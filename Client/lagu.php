        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active fw-bold" id="navbarDropdown" href="products.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">Lagu</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item active" href="products.php">Data Lagu</a></li>
                            <li>
                                <hr class="dropdown-divider" />
                            </li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-grid gap-2 col-6 mx-auto">
                                            <a class="btn btn-outline-primary btn-sm" type="button" a href="ubah-products.php?id_lagu=<?= $r->id_lagu ?>">Ubah</a>
                                            <a class="btn btn-outline-danger btn-sm" type="button" a href="proses-products.php?aksi=hapus&id_lagu=<?= $r->id_lagu ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini?')">Hapus</a>
                                        </div>
                                    </td>
