...
<body>
     ...
     <header class="bg-dark py-2">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Edit Customer</h1>
    ...
    <section class="py-5">
        <div class="main-1">
            <?php
            $r = $abc->tampil_customers($_GET['customer_id']);
            ?>
            <form name="form" class="container" method="POST" action="proses-customers.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="customer_id" id="formGroupExampleInput" value="<?= $r->customer_id ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">First Name</label>
                    <input type="text" class="form-control" name="first_name" id="formGroupExampleInput2" value="<?= $r->first_name ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Last Name</label>
                    <input type="text" class="form-control" name="last_name" id="formGroupExampleInput2" value="<?= $r->last_name ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Email</label>
                    <input type="text" class="form-control" name="email" id="formGroupExampleInput2" value="<?= $r->email ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">phone_number</label>
                    <input type="text" class="form-control" name="phone_number" id="formGroupExampleInput2" value="<?= $r->phone_number ?>">
                </div>
                  <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">ID Level</label>
                    <input type="text" class="form-control" name="level_id" id="formGroupExampleInput2" value="<?= $r->level_id ?>">
                </div>
                <div class="col-auto">
