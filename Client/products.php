    ...
    <header class="bg-dark py-2">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">Data Produk</p>
            </div>
        </div>
    </header>
            ...
            <div class="container">
                <div class="table-responsive-lg">
                    <table class="table caption-top">
                        <caption class="text-center">Daftar Produk</caption>
                        ...
                        <tbody class="table-border text-center align-middle text-wrap">
                            <?php $no = 1;
                            $data_array = $abc->tampil_semua_products();
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-grid gap-2 col-6 mx-auto">
                                            <a class="btn btn-outline-primary btn-sm" type="button" a href="ubah-products.php?product_id=<?= $r->product_id ?>">Ubah</a>
                                            <a class="btn btn-outline-danger btn-sm" type="button" a href="proses-products.php?aksi=hapus&product_id=<?= $r->product_id ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini?')">Hapus</a>
                                        </div>
                                    </td>
