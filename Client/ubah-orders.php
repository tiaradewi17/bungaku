...
<body>
    ...
    <header class="bg-dark py-2">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Edit Orderan</h1>
                <p class="lead fw-normal text-white-50 mb-0">Order lengkap</p>
            </div>
        </div>
    </header>
    ...
    <section class="py-5">
        <div class="main-1">
            <?php
            $r = $abc->tampil_orders($_GET['order_id']);
            ?>
            <form name="form" class="container" method="POST" action="proses-orders.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="order_id" id="formGroupExampleInput" value="<?= $r->order_id ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">ID Customer</label>
                    <input type="text" class="form-control" name="customer_id" id="formGroupExampleInput2" value="<?= $r->customer_id ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Date Order</label>
                    <input type="text" class="form-control" name="order_date" id="formGroupExampleInput2" value="<?= $r->order_date ?>">
                </div>
                <div class="mb-3">
